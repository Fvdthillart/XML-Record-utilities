    ...
    class AnonymizeCSV
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                AnonymizerCSV myAnonymizer = new AnonymizerCSV(inputfilename, anonymizeFile,seperator,textIndicator);
                        ...
                        while (sr.Peek() >= 0)
                        {
                            ...
                            if (skip_first_row)
                            {
                              ...
                              for(int i = 0;i < headers.Count;i++)
                                headers[i] = headers[i].Replace(textIndicator,"");
                            }
                              ...
                              foreach (AnonymizeRule rule in myAnonymizer.AnonymizerRules)
                              {
                                ...
                                else
                                {
                                  ...
                                  else
                                  {
                                    ...
                                    for (int i = 0; i < headers.Count; i++)
                                    {
                                      if (rule.Location.Replace(textIndicator, "").Equals(headers[i], StringComparison.OrdinalIgnoreCase))
                                      {
                                        pos = i + 1;
                                        break;
                                      }
